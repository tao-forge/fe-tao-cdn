define(['jquery', 'lodash', 'context', 'taoQtiItem/qtiItem/core/Loader', 'taoQtiItem/qtiItem/core/Element', 'taoQtiItem/portableElementRegistry/ciRegistry', 'taoQtiItem/portableElementRegistry/icRegistry', 'taoQtiItem/portableElementRegistry/provider/sideLoadingProviderFactory', 'taoQtiItem/runner/rendererStrategies', 'taoQtiItem/runner/provider/manager/picManager', 'taoQtiItem/runner/provider/manager/userModules', 'taoQtiItem/qtiItem/helper/modalFeedback', 'taoQtiItem/runner/utils/imsViewToRendererMaper', 'taoItems/assets/manager'], function ($, _, context, QtiLoader, Element, ciRegistry, icRegistry, sideLoadingProviderFactory, rendererStrategies, picManager, userModules, modalFeedbackHelper, getRendererNameFromView, manager) { 'use strict';
    ...
    sideLoadingProviderFactory = sideLoadingProviderFactory && sideLoadingProviderFactory.hasOwnProperty('default') ? sideLoadingProviderFactory['default'] : sideLoadingProviderFactory;
    rendererStrategies = rendererStrategies && rendererStrategies.hasOwnProperty('default') ? rendererStrategies['default'] : rendererStrategies;
    picManager = picManager && picManager.hasOwnProperty('default') ? picManager['default'] : picManager;
    userModules = userModules && userModules.hasOwnProperty('default') ? userModules['default'] : userModules;
    modalFeedbackHelper = modalFeedbackHelper && modalFeedbackHelper.hasOwnProperty('default') ? modalFeedbackHelper['default'] : modalFeedbackHelper;
    getRendererNameFromView = getRendererNameFromView && getRendererNameFromView.hasOwnProperty('default') ? getRendererNameFromView['default'] : getRendererNameFromView;
