define(['lodash', 'taoQtiItem/scoring/processor/expressions/preprocessor', 'taoQtiItem/scoring/processor/errorHandler', 'taoQtiItem/scoring/processor/expressions/operators/constraintValidator'], function (_, preProcessorFactory, errorHandler, constraintValidator) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    preProcessorFactory = preProcessorFactory && preProcessorFactory.hasOwnProperty('default') ? preProcessorFactory['default'] : preProcessorFactory;
    errorHandler = errorHandler && errorHandler.hasOwnProperty('default') ? errorHandler['default'] : errorHandler;
    constraintValidator = constraintValidator && constraintValidator.hasOwnProperty('default') ? constraintValidator['default'] : constraintValidator;
