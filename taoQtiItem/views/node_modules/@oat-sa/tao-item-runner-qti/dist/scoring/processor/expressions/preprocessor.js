define(['lodash', 'taoQtiItem/scoring/processor/expressions/typeCaster'], function (_, typeCaster) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    typeCaster = typeCaster && typeCaster.hasOwnProperty('default') ? typeCaster['default'] : typeCaster;
