define(['lodash', 'taoQtiItem/scoring/processor/expressions/processor', 'taoQtiItem/scoring/processor/expressions/expressions', 'taoQtiItem/scoring/processor/expressions/operators/operators'], function (_, processorFactory, expressionProcessors, operatorProcessors) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    processorFactory = processorFactory && processorFactory.hasOwnProperty('default') ? processorFactory['default'] : processorFactory;
    expressionProcessors = expressionProcessors && false ? expressionProcessors['default'] : expressionProcessors;
    operatorProcessors = operatorProcessors && operatorProcessors.hasOwnProperty('default') ? operatorProcessors['default'] : operatorProcessors;
