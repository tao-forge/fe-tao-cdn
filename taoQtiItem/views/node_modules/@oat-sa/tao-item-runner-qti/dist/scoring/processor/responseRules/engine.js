define(['lodash', 'taoQtiItem/scoring/processor/responseRules/processor', 'taoQtiItem/scoring/processor/responseRules/rules'], function (_, processorFactory, rules) { 'use strict';
    ...
    rules = rules && rules.hasOwnProperty('default') ? rules['default'] : rules;
