define(['lodash', 'taoQtiItem/scoring/processor/expressions/isPointInShape', 'taoQtiItem/scoring/processor/errorHandler'], function (_, isPointInShape, errorHandler) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    isPointInShape = isPointInShape && isPointInShape.hasOwnProperty('default') ? isPointInShape['default'] : isPointInShape;
