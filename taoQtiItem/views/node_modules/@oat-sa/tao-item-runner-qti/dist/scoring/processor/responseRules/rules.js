define(['taoQtiItem/scoring/processor/responseRules/exitResponse', 'taoQtiItem/scoring/processor/responseRules/responseCondition', 'taoQtiItem/scoring/processor/responseRules/setOutcomeValue'], function (exitResponse, responseCondition, setOutcomeValue) { 'use strict';

    exitResponse = exitResponse && exitResponse.hasOwnProperty('default') ? exitResponse['default'] : exitResponse;
    responseCondition = responseCondition && responseCondition.hasOwnProperty('default') ? responseCondition['default'] : responseCondition;
    setOutcomeValue = setOutcomeValue && setOutcomeValue.hasOwnProperty('default') ? setOutcomeValue['default'] : setOutcomeValue;
