define(['taoQtiItem/scoring/processor/expressions/engine', 'taoQtiItem/scoring/processor/errorHandler'], function (expressionEngineFactory, errorHandler) { 'use strict';

    expressionEngineFactory = expressionEngineFactory && expressionEngineFactory.hasOwnProperty('default') ? expressionEngineFactory['default'] : expressionEngineFactory;
