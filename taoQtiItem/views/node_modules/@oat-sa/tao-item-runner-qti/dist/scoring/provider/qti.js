define(['lodash', 'taoQtiItem/scoring/processor/responseRules/engine', 'taoQtiItem/scoring/processor/expressions/preprocessor', 'taoQtiItem/scoring/processor/errorHandler'], function (_, ruleEngineFactory, preProcessor, errorHandler) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    ruleEngineFactory = ruleEngineFactory && ruleEngineFactory.hasOwnProperty('default') ? ruleEngineFactory['default'] : ruleEngineFactory;
    preProcessor = preProcessor && preProcessor.hasOwnProperty('default') ? preProcessor['default'] : preProcessor;
