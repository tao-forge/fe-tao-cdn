define(['lodash', 'handlebars', 'i18n', 'lib/dompurify/purify', 'taoQtiItem/qtiCommonRenderer/helpers/container', 'mathJax'], function (_, Handlebars, __, DOMPurify, containerHelper, MathJax) { 'use strict';
    ...
    MathJax = MathJax && MathJax.hasOwnProperty('default') ? MathJax['default'] : MathJax;
