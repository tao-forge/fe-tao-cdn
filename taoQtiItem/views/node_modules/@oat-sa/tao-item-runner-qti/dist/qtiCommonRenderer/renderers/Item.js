define(['handlebars', 'i18n', 'lodash', 'lib/dompurify/purify', 'taoQtiItem/qtiCommonRenderer/helpers/container', 'taoQtiItem/qtiCommonRenderer/helpers/itemStylesheetHandler'], function (Handlebars, __, _, DOMPurify, containerHelper, itemStylesheetHandler) { 'use strict';
    ...
    itemStylesheetHandler = itemStylesheetHandler && itemStylesheetHandler.hasOwnProperty('default') ? itemStylesheetHandler['default'] : itemStylesheetHandler;
