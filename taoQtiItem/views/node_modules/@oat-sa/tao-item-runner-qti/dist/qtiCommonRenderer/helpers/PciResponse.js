define(['lodash', 'taoQtiItem/qtiCommonRenderer/helpers/PciPrettyPrint'], function (_, pciPrettyPrint) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    pciPrettyPrint = pciPrettyPrint && pciPrettyPrint.hasOwnProperty('default') ? pciPrettyPrint['default'] : pciPrettyPrint;
