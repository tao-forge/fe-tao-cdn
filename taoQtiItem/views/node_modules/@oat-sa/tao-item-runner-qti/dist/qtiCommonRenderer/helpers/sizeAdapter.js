define(['jquery', 'util/adaptSize', 'ui/waitForMedia'], function ($, adaptSize, waitForMedia) { 'use strict';

    $ = $ && $.hasOwnProperty('default') ? $['default'] : $;
    adaptSize = adaptSize && adaptSize.hasOwnProperty('default') ? adaptSize['default'] : adaptSize;
