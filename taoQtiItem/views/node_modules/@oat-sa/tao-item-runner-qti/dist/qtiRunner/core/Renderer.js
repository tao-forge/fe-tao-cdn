define(['lodash', 'jquery', 'taoQtiItem/qtiItem/core/Element', 'taoQtiItem/qtiItem/helper/interactionHelper', 'ui/themeLoader', 'ui/themes', 'core/moduleLoader', 'handlebars'], function (_, $, Element, interactionHelper, themeLoader, themesHelper, moduleLoader, Handlebars) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    $ = $ && $.hasOwnProperty('default') ? $['default'] : $;
    Element = Element && Element.hasOwnProperty('default') ? Element['default'] : Element;
    interactionHelper = interactionHelper && interactionHelper.hasOwnProperty('default') ? interactionHelper['default'] : interactionHelper;
    themeLoader = themeLoader && themeLoader.hasOwnProperty('default') ? themeLoader['default'] : themeLoader;
    themesHelper = themesHelper && themesHelper.hasOwnProperty('default') ? themesHelper['default'] : themesHelper;
