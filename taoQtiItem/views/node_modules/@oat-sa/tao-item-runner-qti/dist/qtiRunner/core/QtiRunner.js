define(['jquery', 'lodash', 'context', 'module', 'iframeNotifier', 'taoQtiItem/qtiItem/core/Loader', 'taoQtiItem/qtiRunner/modalFeedback/inlineRenderer', 'taoQtiItem/qtiRunner/modalFeedback/modalRenderer'], function ($, _, context, module, iframeNotifier, ItemLoader, modalFeedbackInline, modalFeedbackModal) { 'use strict';
    ...
    ItemLoader = ItemLoader && ItemLoader.hasOwnProperty('default') ? ItemLoader['default'] : ItemLoader;
    modalFeedbackInline = modalFeedbackInline && modalFeedbackInline.hasOwnProperty('default') ? modalFeedbackInline['default'] : modalFeedbackInline;
    modalFeedbackModal = modalFeedbackModal && modalFeedbackModal.hasOwnProperty('default') ? modalFeedbackModal['default'] : modalFeedbackModal;
