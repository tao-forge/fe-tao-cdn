define(['handlebars', 'i18n', 'lodash', 'lib/dompurify/purify', 'taoQtiItem/qtiCommonRenderer/renderers/interactions/HotspotInteraction'], function (Handlebars, __, _, DOMPurify, hotspotInteraction) { 'use strict';

    Handlebars = Handlebars && Handlebars.hasOwnProperty('default') ? Handlebars['default'] : Handlebars;
    __ = __ && __.hasOwnProperty('default') ? __['default'] : __;
    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    DOMPurify = DOMPurify && DOMPurify.hasOwnProperty('default') ? DOMPurify['default'] : DOMPurify;
    hotspotInteraction = hotspotInteraction && hotspotInteraction.hasOwnProperty('default') ? hotspotInteraction['default'] : hotspotInteraction;
     ...
     */
    var HotspotInteraction = Object.assign({}, hotspotInteraction, {template});
