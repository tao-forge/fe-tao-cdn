define(['handlebars', 'i18n', 'lodash', 'lib/dompurify/purify', 'taoQtiItem/qtiCommonRenderer/renderers/interactions/TextEntryInteraction'], function (Handlebars, __, _, DOMPurify, textEntryInteraction) { 'use strict';

    Handlebars = Handlebars && Handlebars.hasOwnProperty('default') ? Handlebars['default'] : Handlebars;
    __ = __ && __.hasOwnProperty('default') ? __['default'] : __;
    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    DOMPurify = DOMPurify && DOMPurify.hasOwnProperty('default') ? DOMPurify['default'] : DOMPurify;
    textEntryInteraction = textEntryInteraction && textEntryInteraction.hasOwnProperty('default') ? textEntryInteraction['default'] : textEntryInteraction;
    ...
    var TextEntryInteraction = Object.assign({}, textEntryInteraction, {template});
