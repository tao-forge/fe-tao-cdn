define(['handlebars', 'i18n', 'lodash', 'lib/dompurify/purify', 'taoQtiItem/qtiCommonRenderer/renderers/interactions/GraphicOrderInteraction'], function (Handlebars, __, _, DOMPurify, graphicOrderInteraction) { 'use strict';

    Handlebars = Handlebars && Handlebars.hasOwnProperty('default') ? Handlebars['default'] : Handlebars;
    __ = __ && __.hasOwnProperty('default') ? __['default'] : __;
    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    DOMPurify = DOMPurify && DOMPurify.hasOwnProperty('default') ? DOMPurify['default'] : DOMPurify;
    graphicOrderInteraction = graphicOrderInteraction && graphicOrderInteraction.hasOwnProperty('default') ? graphicOrderInteraction['default'] : graphicOrderInteraction;
     ...
     */
    var GraphicOrderInteraction = Object.assign({}, graphicOrderInteraction, {template});
