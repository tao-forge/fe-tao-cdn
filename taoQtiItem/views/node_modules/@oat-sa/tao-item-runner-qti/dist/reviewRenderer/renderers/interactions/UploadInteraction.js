define(['handlebars', 'i18n', 'lodash', 'lib/dompurify/purify', 'taoQtiItem/qtiCommonRenderer/renderers/interactions/UploadInteraction'], function (Handlebars, __, _, DOMPurify, uploadInteraction) { 'use strict';

    Handlebars = Handlebars && Handlebars.hasOwnProperty('default') ? Handlebars['default'] : Handlebars;
    __ = __ && __.hasOwnProperty('default') ? __['default'] : __;
    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    DOMPurify = DOMPurify && DOMPurify.hasOwnProperty('default') ? DOMPurify['default'] : DOMPurify;
    uploadInteraction = uploadInteraction && uploadInteraction.hasOwnProperty('default') ? uploadInteraction['default'] : uploadInteraction;
    ...
    var UploadInteraction = Object.assign({}, uploadInteraction, {template});
