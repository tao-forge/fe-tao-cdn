define(['jquery', 'lodash', 'taoQtiItem/qtiCommonRenderer/helpers/container', 'taoQtiItem/qtiCommonRenderer/renderers/interactions/MediaInteraction', 'ui/mediaplayer'], function ($, _, containerHelper, mediaInteraction, mediaplayer) { 'use strict';
    ...
    mediaInteraction = mediaInteraction && mediaInteraction.hasOwnProperty('default') ? mediaInteraction['default'] : mediaInteraction;
     ...
     */
    var MediaInteraction = Object.assign({}, mediaInteraction, {render});
