define(['lodash', 'taoQtiItem/qtiItem/core/Element', 'taoQtiItem/qtiItem/mixin/ContainerInline', 'taoQtiItem/qtiItem/helper/rendererConfig'], function (_, Element, ContainerInline, rendererConfig) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    Element = Element && Element.hasOwnProperty('default') ? Element['default'] : Element;
    ContainerInline = ContainerInline && ContainerInline.hasOwnProperty('default') ? ContainerInline['default'] : ContainerInline;
