define(['lodash', 'taoQtiItem/qtiItem/core/interactions/Interaction', 'taoQtiItem/qtiItem/mixin/CustomElement', 'taoQtiItem/qtiItem/mixin/NamespacedElement', 'taoQtiItem/qtiItem/helper/rendererConfig'], function (_, Interaction, CustomElement, NamespacedElement, rendererConfig) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    Interaction = Interaction && Interaction.hasOwnProperty('default') ? Interaction['default'] : Interaction;
    CustomElement = CustomElement && CustomElement.hasOwnProperty('default') ? CustomElement['default'] : CustomElement;
    NamespacedElement = NamespacedElement && NamespacedElement.hasOwnProperty('default') ? NamespacedElement['default'] : NamespacedElement;
