define(['taoQtiItem/qtiItem/core/interactions/BlockInteraction', 'taoQtiItem/qtiItem/core/choices/SimpleAssociableChoice', 'lodash', 'taoQtiItem/qtiItem/helper/rendererConfig', 'taoQtiItem/qtiItem/helper/util', 'taoQtiItem/qtiItem/helper/maxScore'], function (BlockInteraction, SimpleAssociableChoice, _, rendererConfig, util, maxScore) { 'use strict';

    BlockInteraction = BlockInteraction && BlockInteraction.hasOwnProperty('default') ? BlockInteraction['default'] : BlockInteraction;
    SimpleAssociableChoice = SimpleAssociableChoice && SimpleAssociableChoice.hasOwnProperty('default') ? SimpleAssociableChoice['default'] : SimpleAssociableChoice;
    ...
    maxScore = maxScore && maxScore.hasOwnProperty('default') ? maxScore['default'] : maxScore;
