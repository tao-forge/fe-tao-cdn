define(['taoQtiItem/qtiItem/core/Element', 'taoQtiItem/qtiItem/core/IdentifiedElement', 'taoQtiItem/qtiItem/mixin/ContainerItemBody', 'lodash', 'jquery', 'taoQtiItem/qtiItem/helper/util'], function (Element, IdentifiedElement, Container, _, $, util) { 'use strict';

    Element = Element && Element.hasOwnProperty('default') ? Element['default'] : Element;
    IdentifiedElement = IdentifiedElement && IdentifiedElement.hasOwnProperty('default') ? IdentifiedElement['default'] : IdentifiedElement;
