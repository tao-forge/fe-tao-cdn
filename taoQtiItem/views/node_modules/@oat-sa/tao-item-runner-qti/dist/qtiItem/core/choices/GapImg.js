define(['taoQtiItem/qtiItem/core/choices/Choice', 'taoQtiItem/qtiItem/core/Object'], function (QtiChoice, QtiObject) { 'use strict';

    QtiChoice = QtiChoice && QtiChoice.hasOwnProperty('default') ? QtiChoice['default'] : QtiChoice;
    QtiObject = QtiObject && QtiObject.hasOwnProperty('default') ? QtiObject['default'] : QtiObject;
