define(['lodash', 'jquery', 'taoQtiItem/qtiItem/helper/util', 'taoQtiItem/qtiItem/core/Loader'], function (_, $, util, Loader) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    $ = $ && $.hasOwnProperty('default') ? $['default'] : $;
    util = util && util.hasOwnProperty('default') ? util['default'] : util;
    Loader = Loader && Loader.hasOwnProperty('default') ? Loader['default'] : Loader;
    ...
    parser = {
        parse: function(xmlStr, opts) {
            ...
            var element = buildElement($container);
