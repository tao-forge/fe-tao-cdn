define(['lodash', 'taoQtiItem/qtiItem/helper/responseRules'], function (_, responseRulesHelper) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    responseRulesHelper = responseRulesHelper && responseRulesHelper.hasOwnProperty('default') ? responseRulesHelper['default'] : responseRulesHelper;
