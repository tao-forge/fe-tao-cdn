define(['jquery', 'lodash', 'i18n', 'handlebars', 'lib/gamp/gamp'], function ($$1, _, __, Handlebars, gamp) { 'use strict';
    ...
    function templateTpl(data, options, asString) {
    ...
    function _initButtonHighlight(form, key) {
        var $btn = $$1(form).find('[data-key="' + key + '"]');
