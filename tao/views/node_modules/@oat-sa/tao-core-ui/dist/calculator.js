define(['jquery', 'lodash', 'i18n', 'ui/dynamicComponent', 'lib/calculator/index', 'css!ui/calculator/css/calculator.css'], function ($, _, __, dynamicComponent, calculatorBuild, calculator_css) { 'use strict';
    ...
    calculatorBuild = calculatorBuild && calculatorBuild.hasOwnProperty('default') ? calculatorBuild['default'] : calculatorBuild;
