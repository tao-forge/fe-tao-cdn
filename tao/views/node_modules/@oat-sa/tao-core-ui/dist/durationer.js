define(['jquery', 'lodash', 'i18n', 'core/pluginifier', 'handlebars', 'moment', 'ui/incrementer'], function ($, _, __, Pluginifier, Handlebars, moment, incrementer) { 'use strict';
    ...
    var Durationer = {
      ...
      init: function init(options) {
        var self = Durationer; //get options using default
        ...
        return this.each(function () {
          ...
          if (!$elt.data(dataNs)) {
            ...
            if (!$elt.is('input[type="text"]')) {
              ...
              var duration = moment($elt.val(), options.format); //hide the element
       ...
       */
      _insertField: function _insertField($elt, options, value, type) {
        var data = _.defaults({
          type: type,
          value: value,
       ...
       * @param {jQueryElement} $elt - the plugin element
       */
      _syncFromField: function _syncFromField($elt) {
       ...
       * @param {jQueryElement} $elt - the plugin element
       */
      _syncToField: function _syncToField($elt) {
        var options = $elt.data(dataNs);
        var current = moment($elt.val(), options.format);
        options.$ctrls.each(function () {
          var $field = $(this);
