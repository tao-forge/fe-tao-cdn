define(['jquery', 'lodash', 'i18n', 'util/capitalize', 'ui/tooltip', 'jquery.autocomplete', 'css!ui/autocomplete/css/autocomplete.css'], function ($, _, __, capitalize, tooltip, jquery_autocomplete, autocomplete_css) { 'use strict';
    ...
    var autocompleter = {
      ...
      init: function init(element, options) {
        ...
        this.tooltip = tooltip.info(this.$element, toolTipMessage, tooltipConfigTooMany); // loads some options from HTML5 data-* attributes

        options = _.assign(_.clone(options || {}), _.pick(this.$element.data(), ['url', 'ontology', 'paramsRoot', 'ontologyParam', 'queryParam', 'type', 'valueField', 'labelField', 'isProvider', 'preventSubmit', 'delay', 'minChars'])); // install the keyboard listener used to prevent auto submits

        this.on('keyup keydown keypress', this._onKeyEvent.bind(this)); // install the events listener used to show/hide tooltip

        this.on('focus', this._onFocus.bind(this));
        this.on('blur', this._onBlur.bind(this)); // apply the nested plugin onto the element
