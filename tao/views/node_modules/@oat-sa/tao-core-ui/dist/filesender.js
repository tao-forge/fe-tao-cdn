define(['jquery', 'lodash', 'layout/logout-event'], function ($, _, logoutEvent) { 'use strict';

    $ = $ && $.hasOwnProperty('default') ? $['default'] : $;
    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    logoutEvent = logoutEvent && logoutEvent.hasOwnProperty('default') ? logoutEvent['default'] : logoutEvent;
    ...
    var FileSender = {
      ...
      _init: function _init(options) {
        ...
        if (xhr2) {
          //send using xhr2
          xhr = new XMLHttpRequest(); //post the full form that contains the file
