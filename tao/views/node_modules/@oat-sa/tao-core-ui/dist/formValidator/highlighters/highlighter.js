define(['jquery', 'ui/formValidator/highlighters/message', 'ui/formValidator/highlighters/tooltip'], function ($, messageHighlighter, tooltipHighlighter) { 'use strict';

    $ = $ && $.hasOwnProperty('default') ? $['default'] : $;
    messageHighlighter = messageHighlighter && messageHighlighter.hasOwnProperty('default') ? messageHighlighter['default'] : messageHighlighter;
    tooltipHighlighter = tooltipHighlighter && tooltipHighlighter.hasOwnProperty('default') ? tooltipHighlighter['default'] : tooltipHighlighter;
