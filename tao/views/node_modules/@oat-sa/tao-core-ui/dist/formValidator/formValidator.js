define(['jquery', 'lodash', 'ui/formValidator/highlighters/highlighter', 'ui/validator'], function ($, _, highlighterFactory, validator) { 'use strict';
      ...
      validator = {
        init: function init() {
          ...
          $toValidate.validator({
            ...
            validated: function validated(valid, report) {
