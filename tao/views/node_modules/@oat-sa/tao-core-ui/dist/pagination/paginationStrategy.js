define(['core/providerRegistry', 'ui/pagination/providers/pages', 'ui/pagination/providers/simple'], function (providerRegistry, pagesProvider, simpleProvider) { 'use strict';

    providerRegistry = providerRegistry && providerRegistry.hasOwnProperty('default') ? providerRegistry['default'] : providerRegistry;
    pagesProvider = pagesProvider && pagesProvider.hasOwnProperty('default') ? pagesProvider['default'] : pagesProvider;
    simpleProvider = simpleProvider && simpleProvider.hasOwnProperty('default') ? simpleProvider['default'] : simpleProvider;
