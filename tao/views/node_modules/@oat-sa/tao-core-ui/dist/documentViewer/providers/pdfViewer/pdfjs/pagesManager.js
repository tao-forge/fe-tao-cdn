define(['lodash', 'ui/documentViewer/providers/pdfViewer/pdfjs/pageView'], function (_, pageViewFactory) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    pageViewFactory = pageViewFactory && pageViewFactory.hasOwnProperty('default') ? pageViewFactory['default'] : pageViewFactory;
