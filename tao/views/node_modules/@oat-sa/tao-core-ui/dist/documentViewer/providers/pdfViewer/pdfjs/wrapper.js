define(['lodash', 'ui/documentViewer/providers/pdfViewer/pdfjs/pagesManager', 'ui/documentViewer/providers/pdfViewer/pdfjs/textManager'], function (_, pagesManagerFactory, textManagerFactory) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    pagesManagerFactory = pagesManagerFactory && pagesManagerFactory.hasOwnProperty('default') ? pagesManagerFactory['default'] : pagesManagerFactory;
    textManagerFactory = textManagerFactory && textManagerFactory.hasOwnProperty('default') ? textManagerFactory['default'] : textManagerFactory;
