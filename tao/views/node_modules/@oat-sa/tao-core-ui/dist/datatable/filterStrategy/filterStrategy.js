define(['core/providerRegistry', 'ui/datatable/filterStrategy/multiple', 'ui/datatable/filterStrategy/single'], function (providerRegistry, multipleStrategy, singleStrategy) { 'use strict';

    providerRegistry = providerRegistry && providerRegistry.hasOwnProperty('default') ? providerRegistry['default'] : providerRegistry;
    multipleStrategy = multipleStrategy && multipleStrategy.hasOwnProperty('default') ? multipleStrategy['default'] : multipleStrategy;
    singleStrategy = singleStrategy && singleStrategy.hasOwnProperty('default') ? singleStrategy['default'] : singleStrategy;
