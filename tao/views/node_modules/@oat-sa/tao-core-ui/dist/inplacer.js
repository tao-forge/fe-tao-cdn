define(['jquery', 'lodash', 'core/pluginifier', 'core/dataattrhandler'], function ($, _, Pluginifier, DataAttrHandler) { 'use strict';
    ...
    var defaults = {
      ...
      mapping: {
        textarea: ['p', 'div'] //input otherwise
    ...
    var InPlacer = {
      ...
      init: function init(options) {
        ...
        return this.each(function () {
          ...
          if (!$elt.data(dataNs)) {
            ...
            InPlacer._sync($elt, $target); //bind an event to trigger the toggling
       ...
       */
      _sync: function _sync($elt, $target) {
        if ($elt.children(':text').length > 0) {
