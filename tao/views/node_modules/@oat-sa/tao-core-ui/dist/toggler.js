define(['jquery', 'core/pluginifier', 'core/dataattrhandler'], function ($, Pluginifier, DataAttrHandler) { 'use strict';
    ...
    var Toggler = {
      ...
      init: function init(options) {
        ...
        return this.each(function () {
          ...
          if (!$elt.data(dataNs)) {
            ...
            $elt.data(dataNs, options); //add the default class if not set
      ...
      _toggle: function _toggle($elt) {
        ...
        var triggerEvents = function triggerEvents() {
           ...
           */
          $elt.trigger('toggle.' + ns, [$target]).trigger(action + '.' + ns, [$target]); //trigger also on the target in case of multiple toggling
