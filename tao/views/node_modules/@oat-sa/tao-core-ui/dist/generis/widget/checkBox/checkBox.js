define(['jquery', 'lodash', 'i18n', 'ui/generis/widget/widget', 'handlebars', 'lib/dompurify/purify'], function ($$1, _, __, widgetFactory, Handlebars, DOMPurify) { 'use strict';
  ...
  function factory(options, config) {
    ...
    var widget; // todo - handle required fields
