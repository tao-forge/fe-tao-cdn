define(['jquery', 'lodash', 'i18n', 'core/mimetype', 'core/pluginifier', 'ui/mediaplayer', 'iframeNotifier', 'ui/documentViewer', 'ui/documentViewer/providers/pdfViewer'], function ($, _, __, mimeType, Pluginifier, mediaplayer, iframeNotifier, documentViewer, pdfViewer) { 'use strict';
    ...
    documentViewer = documentViewer && documentViewer.hasOwnProperty('default') ? documentViewer['default'] : documentViewer;
    ...
    var previewer = {
      ...
      init: function init(options) {
        var self = previewer; //get options using default
        ...
        if (options) {
          ...
          if (options.url) {
            if (type === 'audio' || type === 'video') {
              ...
              self._setPlayer($elt, player); // stop video and free the socket on escape keypress(modal window hides)
              ...
              }).load(options.url, 'pdf'); //if the documenviewer is used within the test runner (the old one)
