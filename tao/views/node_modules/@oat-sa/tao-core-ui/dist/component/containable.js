define(['lodash', 'ui/component/placeable'], function (_, makePlaceable) { 'use strict';
    ...
    var containableComponent = {
      ...
      containIn: function containIn($container, options) {
        ...
        self.off('move' + ns).on('move' + ns, function () {
          ...
          self.off('move' + ns); // position component

          self._containComponent($container, options); // re-bind listener
