define(['lodash', 'interact', 'ui/component/placeable'], function (_, interact, makePlaceable) { 'use strict';
    ...
    var resizableComponent = {
       ...
       * @private
       */
      _getCappedValue: function _getCappedValue(value, min, max) {
        var capped = value;
      ...
      resizeTo: function resizeTo(newWidth, newHeight, resizeFromLeft, resizeFromTop) {
        ...
        if (this.is('rendered') && !this.is('disabled')) {
          ...
          position = this.getPosition(); // make sure the component will stay right-aligned if resized from the left
