define(['jquery', 'lodash'], function ($, _) { 'use strict';
    ...
    function fileBrowser (options) {
      ...
      var fileTree = {}; //create the tree node for the ROOT folder by default

      $folderContainer.append('<li class="root"><a class="root-folder" href="#"></a></li>'); //load the content of the ROOT

      getFolderContent(fileTree, path, function (content) {
        var $rootNode = $('.root-folder', $folderContainer); //create an inner list and append found elements
