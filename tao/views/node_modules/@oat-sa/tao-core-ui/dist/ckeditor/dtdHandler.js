define(['lodash'], function (_) { 'use strict';
    ...
    var dtdHandler = function () {
      ...
      dtds.html = function () {
        ...
        X(P, PF, T, DP); // Flow elements := FO + P + DFO
      ...
      dtds.qti = function () {
        var element,
          ...
          table: {
            ...
            intersection; // remove html5-only keys
        ...
        for (element in overrides) {
          ...
          for (actCnt = 0; actCnt < actLnt; actCnt++) {
            ...
            listCnt = overrides[element][action].length; // allow 'all' as a shortcut for 'remove all children'
            ...
            while (listCnt--) {
              child = overrides[element][action][listCnt]; // there was some weird behaviour with references
