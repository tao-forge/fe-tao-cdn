define(['lodash', 'core/eventifier', 'core/dataProvider/request', 'core/polling', 'css!ui/taskQueue/css/taskQueue.css'], function (_, eventifier, request, polling, taskQueue_css) { 'use strict';
