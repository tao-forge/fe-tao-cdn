define(['jquery', 'lodash', 'core/pluginifier', 'lib/gamp/gamp'], function ($, _, Pluginifier, gamp) { 'use strict';
    ...
    var Incrementer = {
      ...
      init: function init(options) {
        var self = Incrementer; //get options using default
            ...
            if (!$elt.is('input[type="text"]')) {
              ...
              .on('keyup', _.debounce(function () {
                var value = $elt.val(),
                    ...
                    options = $elt.data(dataNs); //sanitize the string by removing all invalid characters (only allow digit and dot)
      ...
      _toFixedDown: function _toFixedDown(number, precision) {
        var m = Math.pow(10, precision || 0);
        return Math.floor(number * m) / m;
      },
      _decimalPlaces: function _decimalPlaces(number) {
