define(['lodash', 'async', 'ui/validator/Report', 'ui/validator/validators'], function (_, async, Report, validators) { 'use strict';
    ...
    validators = validators && validators.hasOwnProperty('default') ? validators['default'] : validators;
