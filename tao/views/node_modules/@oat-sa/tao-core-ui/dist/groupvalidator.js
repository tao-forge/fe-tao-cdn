define(['jquery', 'lodash', 'ui/validator'], function ($, _, validator) { 'use strict';
    ...
    $.fn.groupValidator = function (options) {
      ...
      return this.each(function () {
        ...
        var callback = function callback(valid, results) {
          var $elt = $(this); //update global state

          states[$elt.attr('name')] = valid; //call custom callback

          options.callback.call(this, valid, results, options); //trigger event on single validation
    ...
    $.fn.groupValidator.defaults = {
      ...
      events: ['change', 'blur'],
      callback: function callback(valid, results, options) {
        var $elt = $(this),
            rule; //removes previous error messages
