define(['lib/gamp/gamp'], function (gamp) { 'use strict';
    ...
    var calculateByHeight = function calculateByHeight(conf, height, maxWidth) {
      var ratio = getActualRatio(conf);
      var val = parseVal(height, conf.precision); // set height
    ...
    var setPercent = function setPercent(conf, percent, maxWidth) {
      ...
      conf.sizeProps.ratio.current = conf.sizeProps.ratio.natural; // changing non-responsive mode accordingly
