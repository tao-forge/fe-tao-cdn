define(['lodash', 'ui/maths/calculator/core/terms', 'ui/maths/calculator/core/tokens', 'lib/moo/moo'], function (_, registeredTerms, tokensHelper, moo) { 'use strict';
    ...
    moo = moo && moo.hasOwnProperty('default') ? moo['default'] : moo;
    ...
    function calculatorTokenizerFactory(config) {
      ...
      var next = function next() {
        ...
        if (!term) {
          ...
          do {
            term = lexer.next();
          } while (term && ignoredTokens[term.type]); // rely on a specific lexer to tokenize numbers
      ...
      keywordsTransform = moo.keywords(config.keywords); // Lexer used to tokenize the expression
      ...
      }, config.symbols)); // Lexer used to tokenize numbers
