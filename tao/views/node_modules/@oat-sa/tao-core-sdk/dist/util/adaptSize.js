define(['jquery', 'util/capitalize'], function ($, capitalize) { 'use strict';
    ...
    var adaptSize = function () {
       ...
       * @private
       */
      var _resize = function _resize($elements, dimensions) {
      ...
      return {
         ...
         */
        width: function width($elements, minWidth) {
          _resize($elements, {
            width: minWidth
          });
        },
         ...
         */
        height: function height($elements, minHeight) {
          _resize($elements, {
            height: minHeight
          });
        },
         ...
         * @param {Integer|undefined} [minHeight] default: 0
         */
        both: function both($elements, minWidth, minHeight) {
          _resize($elements, {
            height: minHeight,
            width: minWidth
          });
