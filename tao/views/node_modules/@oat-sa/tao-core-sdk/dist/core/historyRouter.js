define(['jquery', 'lodash', 'core/router', 'core/eventifier', 'core/statifier', 'core/promise'], function ($, _, router, eventifier, statifier, Promise) { 'use strict';
    ...
    function historyRouterFactory() {
      ...
      window.history.replaceState({
        url: location
      }, '', location); //back & forward button, and push state
