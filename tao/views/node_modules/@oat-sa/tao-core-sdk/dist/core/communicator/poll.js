define(['lodash', 'core/polling', 'core/promise', 'core/request'], function (_, pollingFactory, Promise, coreRequest) { 'use strict';
    ...
    var pollProvider = {
      ...
      init: function init() {
        ...
        var config = _.defaults(this.getConfig(), defaults); // validate the config
        ...
        this.request = function request() {
          return new Promise(function (resolve) {
            ...
            var extendedRequestParams = Object.assign({}, defaultRequestParams, config.requestParams); // then reset the list of pending messages

            self.messagesQueue = [];
            coreRequest(extendedRequestParams).then(function (response) {
              ...
              error.purpose = 'communicator'; // reject all message promises
      ...
      send: function send(channel, message) {
        ...
        this.messagesQueue.push(pending); // force a send in the next throttle period
