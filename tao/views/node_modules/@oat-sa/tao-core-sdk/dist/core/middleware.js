define(['lodash', 'core/eventifier', 'core/promise'], function (_, eventifier, Promise) { 'use strict';
    ...
    function middlewareFactory() {
      ...
      var middlewareHandler = eventifier({
        ...
        apply: function apply(request, response, context) {
          ...
          var pointer = 0; // apply each middleware in series, then resolve or reject the promise
