define(['jquery', 'lodash', 'i18n', 'core/polling', 'ui/waitingDialog/waitingDialog', 'taoTests/runner/plugin', 'handlebars'], function ($$1, _, __, pollingFactory, waitingDialog, pluginFactory, Handlebars) { 'use strict';
