          ...
          testRunner.before('renderitem resumeitem', function () {
            ...
            if (self.timerbox) {
              ...
              var updatedTimers = Object.keys(timers).reduce(function (acc, timerName) {
                var stats = statsHelper.getInstantStats(timers[timerName].scope, testRunner);
                var unansweredQuestions = stats && stats.questions - stats.answered;
          ...
          timeStore.getItem('zen-mode').then(function (startZen) {
            ...
            if (!config.contextualWarnings) {
              ...
              self.timerbox.on('warnscreenreader', _.debounce(function (message, remainingTime, scope) {
                var stats = statsHelper.getInstantStats(scope, testRunner);
                var unansweredQuestions = stats && stats.questions - stats.answered;
