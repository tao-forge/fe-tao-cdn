        ...
        function doNext(nextItemWarning) {
          ...
          if (self.getState('enabled') !== false) {
            ...
            if (warningHelper.shouldWarnBeforeEndPart()) {
              testRunner.trigger('confirm.endTestPart', messages.getExitMessage(warningScope, testRunner), triggerNextAction, // if the test taker accept
              ...
              testRunner.trigger('confirm.endTest', messages.getExitMessage(warningScope, testRunner, __('You will not be able to return to this test after you submit your answers.')), triggerNextAction, // if the test taker accept
              enableNav, // if he refuse
              {
                buttons: {
                  labels: {
