        ...
        this.$element.on('click', function (e) {
          ...
          if (_this.getState('enabled') !== false) {
            ...
            if (endTestWarning && isLast) {
              testRunner.trigger('confirm.endTest', messages.getExitMessage('test', testRunner, __('You will not be able to access this test once submitted. Click OK to continue and submit the test.')), doSkip, // if the test taker accept
